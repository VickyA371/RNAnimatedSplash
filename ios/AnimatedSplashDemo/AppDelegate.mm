...
//#import "AnimatedSplashDemo-Bridging-Header.h" // here, change project name to yours

#import "AnimatedSplashDemo-Swift.h"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  UIView *rootView = RCTAppSetupDefaultRootView(bridge, @"AnimatedSplashDemo", initProps);
  ...
  /* here */
    LogoAnimationView *t = [LogoAnimationView new];
